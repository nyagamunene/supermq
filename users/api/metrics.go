...
func (ms *metricsMiddleware) RegisterClient(ctx context.Context, token string, client mgclients.Client) (mgclients.Client, errors.Error) {
...
func (ms *metricsMiddleware) IssueToken(ctx context.Context, identity, secret, domainID string) (*magistrala.Token, errors.Error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) RefreshToken(ctx context.Context, refreshToken, domainID string) (token *magistrala.Token, err errors.Error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) ViewClient(ctx context.Context, token, id string) (mgclients.Client, errors.Error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) ViewProfile(ctx context.Context, token string) (mgclients.Client, errors.Error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) ListClients(ctx context.Context, token string, pm mgclients.Page) (mgclients.ClientsPage, errors.Error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) UpdateClient(ctx context.Context, token string, client mgclients.Client) (mgclients.Client, errors.Error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) UpdateClientTags(ctx context.Context, token string, client mgclients.Client) (mgclients.Client, errors.Error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) UpdateClientIdentity(ctx context.Context, token, id, identity string) (mgclients.Client, errors.Error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) UpdateClientSecret(ctx context.Context, token, oldSecret, newSecret string) (mgclients.Client, errors.Error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) ResetSecret(ctx context.Context, token, secret string) errors.Error {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) SendPasswordReset(ctx context.Context, host, email, user, token string) errors.Error {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) UpdateClientRole(ctx context.Context, token string, client mgclients.Client) (mgclients.Client, errors.Error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) EnableClient(ctx context.Context, token, id string) (mgclients.Client, errors.Error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) DisableClient(ctx context.Context, token, id string) (mgclients.Client, errors.Error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) ListMembers(ctx context.Context, token, objectKind, objectID string, pm mgclients.Page) (mp mgclients.MembersPage, err errors.Error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) Identify(ctx context.Context, token string) (string, errors.Error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) OAuthCallback(ctx context.Context, client mgclients.Client) (*magistrala.Token, errors.Error) {
	defer func(begin time.Time) {
