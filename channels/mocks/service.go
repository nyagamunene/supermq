...
// ViewChannel provides a mock function with given fields: ctx, session, id, getRoles
func (_m *Service) ViewChannel(ctx context.Context, session authn.Session, id string, getRoles bool) (channels.Channel, error) {
