...
func (es *eventStore) ViewChannel(ctx context.Context, session authn.Session, id string, getRoles bool) (channels.Channel, error) {
	chann, err := es.svc.ViewChannel(ctx, session, id, getRoles)
	if err != nil {
		return chann, err
	}
