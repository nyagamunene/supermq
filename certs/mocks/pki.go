...
func (_m *Agent) GetDownloadToken(serialNumber string) (certssdk.Token, error) {
	ret := _m.Called(serialNumber)
	...
	var r0 certssdk.Token
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (certssdk.Token, error)); ok {
		return rf(serialNumber)
	}
	if rf, ok := ret.Get(0).(func(string) certssdk.Token); ok {
		r0 = rf(serialNumber)
	} else {
		r0 = ret.Get(0).(certssdk.Token)
	}
...
func (_c *Agent_GetDownloadToken_Call) Return(_a0 certssdk.Token, _a1 error) *Agent_GetDownloadToken_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Agent_GetDownloadToken_Call) RunAndReturn(run func(string) (certssdk.Token, error)) *Agent_GetDownloadToken_Call {
	_c.Call.Return(run)
	return _c
}

// Issue provides a mock function with given fields: entityId, ttl, ipAddrs
func (_m *Agent) Issue(entityId string, ttl string, ipAddrs []string) (certssdk.SerialNumber, error) {
	...
	var r0 certssdk.SerialNumber
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, []string) (certssdk.SerialNumber, error)); ok {
		return rf(entityId, ttl, ipAddrs)
	}
	if rf, ok := ret.Get(0).(func(string, string, []string) certssdk.SerialNumber); ok {
		r0 = rf(entityId, ttl, ipAddrs)
	} else {
		r0 = ret.Get(0).(certssdk.SerialNumber)
	}
...
func (_c *Agent_Issue_Call) Return(_a0 certssdk.SerialNumber, _a1 error) *Agent_Issue_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Agent_Issue_Call) RunAndReturn(run func(string, string, []string) (certssdk.SerialNumber, error)) *Agent_Issue_Call {
	_c.Call.Return(run)
	return _c
}

// ListCerts provides a mock function with given fields: pm
func (_m *Agent) ListCerts(pm certssdk.PageMetadata) (certssdk.CertificatePage, error) {
	ret := _m.Called(pm)
	...
	var r0 certssdk.CertificatePage
	var r1 error
	if rf, ok := ret.Get(0).(func(certssdk.PageMetadata) (certssdk.CertificatePage, error)); ok {
		return rf(pm)
	}
	if rf, ok := ret.Get(0).(func(certssdk.PageMetadata) certssdk.CertificatePage); ok {
		r0 = rf(pm)
	} else {
		r0 = ret.Get(0).(certssdk.CertificatePage)
	}

	if rf, ok := ret.Get(1).(func(certssdk.PageMetadata) error); ok {
		r1 = rf(pm)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Agent_ListCerts_Call) Run(run func(pm certssdk.PageMetadata)) *Agent_ListCerts_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(certssdk.PageMetadata))
	})
	return _c
}

func (_c *Agent_ListCerts_Call) Return(_a0 certssdk.CertificatePage, _a1 error) *Agent_ListCerts_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Agent_ListCerts_Call) RunAndReturn(run func(certssdk.PageMetadata) (certssdk.CertificatePage, error)) *Agent_ListCerts_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Agent) View(serialNumber string) (certssdk.Certificate, error) {
	ret := _m.Called(serialNumber)
	...
	var r0 certssdk.Certificate
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (certssdk.Certificate, error)); ok {
		return rf(serialNumber)
	}
	if rf, ok := ret.Get(0).(func(string) certssdk.Certificate); ok {
		r0 = rf(serialNumber)
	} else {
		r0 = ret.Get(0).(certssdk.Certificate)
	}
...
func (_c *Agent_View_Call) Return(_a0 certssdk.Certificate, _a1 error) *Agent_View_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Agent_View_Call) RunAndReturn(run func(string) (certssdk.Certificate, error)) *Agent_View_Call {
	_c.Call.Return(run)
	return _c
}
