...
type SDK interface {
	...
	//		Offset: 0,
	//		Limit:  10,
	//		Permission: "edit", // available Options:  "administrator", "delete", edit", "view", "share", "owner", "admin", "editor", "contributor", "create"
	//	}
	...
	// example:
	// req := sdk.UsersRelationRequest{
	//		Relation: "contributor", // available options: "owner", "administrator", "editor", "contributor", "guest"
	// 		UserIDs: ["user_id_1", "user_id_2", "user_id_3"]
	// }
	...
	// example:
	// req := sdk.UsersRelationRequest{
	//		Relation: "contributor", // available options: "owner", "administrator", "editor", "contributor", "member", "guest"
	//  	UserIDs: ["user_id_1", "user_id_2", "user_id_3"]
	// }
