...
func (am *authorizationMiddleware) RetrieveDomain(ctx context.Context, session authn.Session, id string, getRoles bool) (domains.Domain, error) {
	...
	return am.svc.RetrieveDomain(ctx, session, id, getRoles)
}
