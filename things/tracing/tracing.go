...
func (tm *tracingMiddleware) CreateThings(ctx context.Context, token string, clis ...mgclients.Client) ([]mgclients.Client, errors.Error) {
...
func (tm *tracingMiddleware) ViewClientPerms(ctx context.Context, token, id string) ([]string, errors.Error) {
...
func (tm *tracingMiddleware) ListClients(ctx context.Context, token, reqUserID string, pm mgclients.Page) (mgclients.ClientsPage, errors.Error) {
...
func (tm *tracingMiddleware) ListClientsByGroup(ctx context.Context, token, groupID string, pm mgclients.Page) (mgclients.MembersPage, errors.Error) {
...
func (tm *tracingMiddleware) Identify(ctx context.Context, key string) (string, errors.Error) {
...
func (tm *tracingMiddleware) Authorize(ctx context.Context, req *magistrala.AuthorizeReq) (string, errors.Error) {
...
func (tm *tracingMiddleware) Share(ctx context.Context, token, id, relation string, userids ...string) errors.Error {
...
func (tm *tracingMiddleware) Unshare(ctx context.Context, token, id, relation string, userids ...string) errors.Error {
...
func (tm *tracingMiddleware) DeleteClient(ctx context.Context, token, id string) errors.Error {
