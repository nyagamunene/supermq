...
func (_m *PATS) AddScopeEntry(ctx context.Context, token string, patID string, scopes []auth.Scope) error {
...
func (_m *PATS) RemoveScopeEntry(ctx context.Context, token string, patID string, scopeIDs ...string) error {
