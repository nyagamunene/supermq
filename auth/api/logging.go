...
func (lm *loggingMiddleware) ListAllObjects(ctx context.Context, pr auth.PolicyReq) (p auth.PolicyPage, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "List all objects failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) CountObjects(ctx context.Context, pr auth.PolicyReq) (count uint64, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Count objects failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) ListSubjects(ctx context.Context, pr auth.PolicyReq, nextPageToken string, limit uint64) (p auth.PolicyPage, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "List subjects failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) ListAllSubjects(ctx context.Context, pr auth.PolicyReq) (p auth.PolicyPage, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "List all subjects failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) CountSubjects(ctx context.Context, pr auth.PolicyReq) (count uint64, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Count subjects failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) ListPermissions(ctx context.Context, pr auth.PolicyReq, filterPermissions []string) (p auth.Permissions, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "List permissions failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) Issue(ctx context.Context, token string, key auth.Key) (tkn auth.Token, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Issue key failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) Revoke(ctx context.Context, token, id string) (err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Revoke key failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) RetrieveKey(ctx context.Context, token, id string) (key auth.Key, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Retrieve key failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) Identify(ctx context.Context, token string) (id auth.Key, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Identify key failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) Authorize(ctx context.Context, pr auth.PolicyReq) (err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Authorize failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) AddPolicy(ctx context.Context, pr auth.PolicyReq) (err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Add policy failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) AddPolicies(ctx context.Context, prs []auth.PolicyReq) (err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, fmt.Sprintf("Add %d policies failed to complete successfully", len(prs)), args...)
			return
		}
...
func (lm *loggingMiddleware) DeletePolicy(ctx context.Context, pr auth.PolicyReq) (err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Delete policy failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) DeletePolicies(ctx context.Context, prs []auth.PolicyReq) (err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, fmt.Sprintf("Delete %d policies failed to complete successfully", len(prs)), args...)
			return
		}
...
func (lm *loggingMiddleware) CreateDomain(ctx context.Context, token string, d auth.Domain) (do auth.Domain, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			...
			lm.logger.ErrorContext(ctx, "Create domain failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) RetrieveDomain(ctx context.Context, token, id string) (do auth.Domain, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Retrieve domain failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) RetrieveDomainPermissions(ctx context.Context, token, id string) (permissions auth.Permissions, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Retrieve domain permissions failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) UpdateDomain(ctx context.Context, token, id string, d auth.DomainReq) (do auth.Domain, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Update domain failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) ChangeDomainStatus(ctx context.Context, token, id string, d auth.DomainReq) (do auth.Domain, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Change domain status failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) ListDomains(ctx context.Context, token string, page auth.Page) (do auth.DomainsPage, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "List domains failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) AssignUsers(ctx context.Context, token, id string, userIds []string, relation string) (err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Assign users to domain failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) UnassignUsers(ctx context.Context, token, id string, userIds []string, relation string) (err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "Unassign users to domain failed to complete successfully", args...)
			return
		}
...
func (lm *loggingMiddleware) ListUserDomains(ctx context.Context, token, userID string, page auth.Page) (do auth.DomainsPage, err error) {
	defer func(begin time.Time) {
		...
		if err != nil {
			args = append(args, slog.Any("error", err))
			lm.logger.ErrorContext(ctx, "List user domains failed to complete successfully", args...)
			return
		}
